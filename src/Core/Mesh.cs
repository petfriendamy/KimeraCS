...
namespace KimeraCS.Rendering
{
    ...
    public class PModelMesh : IDisposable
    {
        ...
        public void UpdateFromPModel(PModel model)
        {
            // Dispose existing groups and recreate
            if (Groups != null)
            {
            ...
            var newMesh = FromPModel(model);
            Groups = newMesh.Groups;
            newMesh.Groups = null; // Prevent disposal of transferred groups
        }
